...
export const WaitingForDeployment = (props: WaitingForTransactionProps) => (
  <WaitingForTransaction
    ...
    description={props.description || WAITING_FOR_TRANSACTION_DESCRIPTION}
    info={props.info}
  />
);

export const WAITING_FOR_TRANSACTION_DESCRIPTION = 'It takes time to register your username and deploy your wallet. In order to do so, we need to create a transaction and wait until the Ethereum blockchain validates it.';
