...
import {
  ...
  ReactModalContext,
  ReactModalProps
} from "./core/models/ReactModalContext";
...
const ATTACKER_ADDRESS_1_COMMON_CODE = [
  //   \/ common prefix
        ...
        <div className="playground-content">
          <Switch>
            <Route
              exact
              path="/"
              render={() => <p>Welcome to Universal Login</p>}
            />
            <Route
              exact
              path="/logobutton"
              render={() => (
                <div>
                  <CreateRandomInstance
                    setApplicationWallet={setApplicationWallet}
                  />
                  <hr />
