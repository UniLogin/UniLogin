        ...
        <div className="container">
          <div className="row">
            ...
            <div>
              ...
              <p className="wallet-address">0xcee7a4d8be1c30623adc6185b6cdbcba19fac166</p>
            </div>
          </div>
          ...
          <button onClick={() => this.props.setView('MainScreen')} className="btn fullwidth start-btn">Start using App</button>
        </div>
      </div>
     );
  }
