    ...
    return (
      <div className="subview">
        <div className="container">
          ...
          <p className="backup-text">Keep this codes somewhere safe and secret. Also, don't forget your username as it's required to recover access. These are independent codes, use each one once. Keep offline and away from computers.</p>
          ...
          <p className="click-cost"><i>Costs 2 clicks</i></p>
          <div className="text-center">
            <button onClick={() => this.props.setView('Account')} className="cancel-backup-btn">Cancel backup code</button>
          </div>
        </div>
      </div>
    );
