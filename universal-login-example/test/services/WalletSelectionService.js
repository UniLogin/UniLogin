...
describe('WalletSelectionService', () => {
  describe('Connections', () => {
    ...
    it('gets connections for identities that exist', async () => {
      const getWalletContractAddress = sinon.stub();
      getWalletContractAddress.withArgs('a.my.eth').returns(Promise.resolve(true));
      getWalletContractAddress.withArgs('a.uni.eth').returns(Promise.resolve(false));
      getWalletContractAddress.withArgs('a.app.eth').returns(Promise.resolve(true));
      const service = new WalletSelectionService({getWalletContractAddress}, domains);
    ...
    it('returns empty for full domain that does not exist', async () => {
      const sdk = {getWalletContractAddress: sinon.fake.returns(Promise.resolve(false))};
      const service = new WalletSelectionService(sdk, domains);
  ...
  describe('Get all suggestions', () => {
    ...
    it('invalid domain', async () => {
      const getWalletContractAddress = sinon.stub();
      getWalletContractAddress.withArgs('a.nothing.eth').returns(Promise.resolve(false));
      getWalletContractAddress.withArgs('a.nothing.eth').returns(Promise.resolve(false));
      getWalletContractAddress.withArgs('a.nothing.eth').returns(Promise.resolve(false));
      const service = new WalletSelectionService({getWalletContractAddress}, domains);
