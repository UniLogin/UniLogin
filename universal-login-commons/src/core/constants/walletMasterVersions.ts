export const WALLET_MASTER_VERSIONS: Record<string, WalletVersion> = {
  ...
  '0x51a5d2b16b9b4db363c860ad48a896243a9d08a4e0aedecf2eb3b725b41f25d6': 'beta3',
  '0x56b8be58b5ad629a621593a2e5e5e8e9a28408dc06e95597497b303902772e45': 'beta3', // Copied from etherscan
};
