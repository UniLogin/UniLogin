import {ApplicationWallet, SerializableFutureWallet, SerializableConfirmedWallet, SerializableRequestedWallet} from '@unilogin/commons';
...
export type SerializedWalletState = {
  ...
  kind: 'Requested';
  wallet: SerializableRequestedWallet;
} | {
  kind: 'Confirmed';
