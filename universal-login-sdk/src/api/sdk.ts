...
import {BlockState} from '../core/states/BlockState';
...
class UniversalLoginSDK {
  ...
  constructor(
    ...
    this.walletEventsObserverFactory = new WalletEventsObserverFactory(this.blockchainService, new BlockState(this.blockchainService));
