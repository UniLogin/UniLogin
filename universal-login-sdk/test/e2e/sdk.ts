...
describe('E2E: SDK', async () => {
  ...
  beforeEach(async () => {
    ...
    executionOptions = {gasPrice: DEFAULT_GAS_PRICE, gasLimit: DEFAULT_GAS_LIMIT, gasToken: mockToken.address};
  });
  ...
  describe('Execute signed message', async () => {
    ...
    it('when not enough gas', async () => {
      const gasBase = 8720;
      const notEnoughGasLimit = 35100;
      message = {...message, gasLimit: gasBase + notEnoughGasLimit};
