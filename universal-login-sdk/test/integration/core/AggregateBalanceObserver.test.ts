...
describe('INT: AggregateBalanceObserver', () => {
  ...
  it('1 subscription - balance 0 -> prices changed', async () => {
    ...
    expect(callback.firstCall.args[0]).to.deep.equal({USD: 0, DAI: 0, SAI: 0, ETH: 0});
    expect(callback.secondCall.args[0]).to.deep.equal({USD: 0, DAI: 0, SAI: 0, ETH: 0});
  });
  ...
  it('1 subscription - balance 0 -> balance changed -> prices changed', async () => {
    ...
    expect(callback.firstCall.args[0]).to.deep.equal({USD: 0, DAI: 0, SAI: 0, ETH: 0});
    expect(callback.secondCall.args[0]).to.deep.equal({USD: 109.105, DAI: 97.19, SAI: 97.19, ETH: 0.009465});
    expect(callback.thirdCall.args[0]).to.deep.equal({USD: 919.255, DAI: 747.355, SAI: 747.355, ETH: 0.049465});
  });
  ...
  it('2 subscriptions - no change -> balance changed -> prices changed', async () => {
    ...
    expect(callback1.firstCall.args[0]).to.deep.equal({USD: 0, DAI: 0, SAI: 0, ETH: 0});
    expect(callback1.secondCall.args[0]).to.deep.equal({USD: 109.105, DAI: 97.19, SAI: 97.19, ETH: 0.009465});

    expect(callback2.firstCall.args[0]).to.deep.equal({USD: 0, DAI: 0, SAI: 0, ETH: 0});
    expect(callback2.secondCall.args[0]).to.deep.equal({USD: 109.105, DAI: 97.19, SAI: 97.19, ETH: 0.009465});
    expect(callback2.thirdCall.args[0]).to.deep.equal({USD: 919.255, DAI: 747.355, SAI: 747.355, ETH: 0.049465});
  });
});
