...
export const ULWeb3Root = ({sdk, walletService, uiController, domains}: ULWeb3RootProps) => {
  ...
  switch (modal.kind) {
    ...
    case 'TRANSACTION_CONFIRMATION':
      return <TransactionConfirmation message={message} walletService={walletService} onError={(errorMessage?: string) => uiController.showError(errorMessage)} {...modal.props} />;
