...
import {raise, asNetwork, asApplicationInfo, asDialogs} from '@unilogin/commons';
...
async function main() {
  ...
  const disabledDialogs = parsedQuery.disabledDialogs ? cast(parsedQuery.disabledDialogs.split(','), asArray(asDialogs)) : [];
