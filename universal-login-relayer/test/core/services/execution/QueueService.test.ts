...
describe('UNIT: Queue Service', () => {
  ...
  beforeEach(async () => {
    ...
    messageExecutor = new MessageExecutor(wallet, messageValidator, messageRepository, minedTransactionHandler, {messageToTransaction: messageToTransaction} as any, gasTokenValidator as any);
