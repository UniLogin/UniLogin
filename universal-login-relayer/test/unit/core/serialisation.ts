...
import {SignedMessage, ACTUAL_WALLET_VERSION, ACTUAL_NETWORK_VERSION} from '@universal-login/commons';
...
describe('UNIT: Coding transaction data', () => {
  ...
  before(async () => {
    message = messageToSignedMessage({...transferMessage, from: '0x123'}, privateKey, ACTUAL_NETWORK_VERSION, ACTUAL_WALLET_VERSION);
  });
