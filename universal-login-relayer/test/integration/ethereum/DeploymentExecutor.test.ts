import setupWalletService, {createFutureWalletUsingEnsServiceUsingEnsService} from '../../testhelpers/setupWalletService';
...
describe('INT: Deployment Executor', () => {
  ...
  beforeEach(async () => {
    ...
    ({signature, futureContractAddress} = await createFutureWalletUsingEnsServiceUsingEnsService(keyPair, ensName, factoryContract, wallet, ensService, ensRegistrar.address, gnosisSafeMaster.address, fallbackHandler.address, '1'));
    deployment = {
