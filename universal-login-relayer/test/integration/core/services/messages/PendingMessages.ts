...
import {calculateMessageHash, SignedMessage, TEST_MESSAGE_HASH, TEST_ACCOUNT_ADDRESS, UnsignedMessage, ACTUAL_WALLET_VERSION, ACTUAL_NETWORK_VERSION} from '@universal-login/commons';
...
describe('INT: PendingMessages', () => {
  ...
  beforeEach(async () => {
    ...
    unsignedMessage = messageToUnsignedMessage({...emptyMessage, from: walletContract.address, to: TEST_ACCOUNT_ADDRESS}, ACTUAL_NETWORK_VERSION, ACTUAL_WALLET_VERSION);
