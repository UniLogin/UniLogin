...
class MessageQueueService {
  ...
  constructor(private messageExecutor: MessageExecutor, private queueStore: IQueueStore, private pendingMessagesStore: IPendingMessagesStore, private tick: number = 100){
    this.state = 'stopped';
  }
