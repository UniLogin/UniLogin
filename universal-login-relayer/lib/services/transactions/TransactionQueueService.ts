...
class QueuedTransactionService {
  ...
  private onTransactionSent?: (transaction: Partial<utils.Transaction>) => Promise<void>;
  ...
  setOnTransactionSent(callback?: (transaction: Partial<utils.Transaction>) => Promise<void>) {
