...
class Relayer {
  ...
  runServer() {
    ...
    this.identityService = new WalletService(this.wallet, this.config.walletMasterAddress, this.ensService, this.authorisationService, this.hooks, this.provider, this.config.legacyENS);
