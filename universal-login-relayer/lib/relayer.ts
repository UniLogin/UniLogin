...
class Relayer {
  ...
  runServer() {
    ...
    this.messageHandler = new MessageHandler(this.wallet, this.authorisationService, this.hooks, this.provider, this.transactionQueueService, this.pendingExecutions);
