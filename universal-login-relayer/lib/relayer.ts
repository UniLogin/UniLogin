...
class Relayer {
  ...
  runServer() {
    ...
    this.walletContractService = new WalletService(this.wallet, this.config.walletMasterAddress, this.ensService, this.hooks, this.config.factoryAddress, this.config.supportedTokens);
