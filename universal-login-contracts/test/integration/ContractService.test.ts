...
import {getContractHash, WALLET_MASTER_VERSIONS, PROXY_VERSIONS, TEST_CONTRACT_ADDRESS, ProviderService} from '@unilogin/commons';
...
import {computeGnosisCounterfactualAddress, ContractService} from '../../src';
